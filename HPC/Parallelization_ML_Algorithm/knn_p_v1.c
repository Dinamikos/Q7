...
int main(){
    ...
    if (rank == 0){
        ...
        MPI_Bcast(&n, 1, MPI_INT, 94, MPI_COMM_WORLD);
        ...
        MPI_Bcast(new_data, 3, MPI_INT, 100, MPI_COMM_WORLD);
        ...
        MPI_Bcast(dataset, n*3, MPI_INT, 97, MPI_COMM_WORLD);
        MPI_Bcast(eucledian_distances, n, MPI_DOUBLE, 98, MPI_COMM_WORLD);
        ...
        MPI_Bcast(eucledian_distances, n, MPI_DOUBLE, 99, MPI_COMM_WORLD);
